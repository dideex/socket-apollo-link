(function (global, factory) {
	...
	***************************************************************************** */
	...
	// typeof document.createElement is 'object' in old IE
	var is$1 = _isObject$1(document$1) && _isObject$1(document$1.createElement);
	...
	_export(_export.S + _export.F * !_descriptors, 'Object', { defineProperties: _objectDps$1 });
	...
	var f$b = _descriptors ? gOPD$2 : function getOwnPropertyDescriptor(O, P) {
	  O = _toIobject$1(O);
	  P = _toPrimitive(P, true);
	  if (_ie8DomDefine) try {
	    return gOPD$2(O, P);
	...
	var _iterDefine$1 = function (Base, NAME, Constructor, next, DEFAULT, IS_SET, FORCED) {
	  ...
	  if ($anyNative) {
	    ...
	    if (IteratorPrototype !== Object.prototype && IteratorPrototype.next) {
	      ...
	      // fix for some old engines
	      if (!_library && typeof IteratorPrototype[ITERATOR$5] != 'function') _hide(IteratorPrototype, ITERATOR$5, returnThis$1);
	    }
	  }
	  // fix Array#{values, @@iterator}.name in V8 / FF
	  ...
	  // Define iterator
	  if ((!_library || FORCED) && (BUGGY$1 || VALUES_BUG || !proto[ITERATOR$5])) {
	...
	for (var collections = _objectKeys$1(DOMIterables$1), i$1 = 0; i$1 < collections.length; i$1++) {
	  ...
	  var key;
	  if (proto$1) {
	    if (!proto$1[ITERATOR$6]) _hide(proto$1, ITERATOR$6, ArrayValues);
	...
	_objectSap$1('keys', function () {
	  return function keys(it) {
	    return _objectKeys$1(_toObject(it));
	  };
	});
	...
	function _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { ownKeys(Object(source), true).forEach(function (key) { defineProperty$5(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }
	...
	var cancel = function cancel(_ref) {
	  ...
	  return _objectSpread(_objectSpread({}, rest), {}, {
	    isActive: false,
	    activeObservers: [],
	    canceledObservers: [].concat(toConsumableArray$1(activeObservers), toConsumableArray$1(canceledObservers))
	  });
	}.bind(undefined);
	...
	var getObservers = function getObservers(_ref) {
	  ...
	  return [].concat(toConsumableArray$1(activeObservers), toConsumableArray$1(canceledObservers));
	}.bind(undefined);
	...
	function _objectSpread$5(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { ownKeys$5(Object(source), true).forEach(function (key) { defineProperty$5(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { ownKeys$5(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }
	...
	function _objectSpread$6(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { ownKeys$6(Object(source), true).forEach(function (key) { defineProperty$5(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { ownKeys$6(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }
	...
	var observe = function observe(_ref, observer) {
	  ...
	  return _objectSpread$6(_objectSpread$6({}, rest), {}, {
	    activeObservers: [].concat(toConsumableArray$1(activeObservers), [observer]),
	    isActive: true
	  });
	}.bind(undefined);
	...
	function _objectSpread$7(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { ownKeys$7(Object(source), true).forEach(function (key) { defineProperty$5(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { ownKeys$7(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }
	...
	function _objectSpread$8(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { ownKeys$8(Object(source), true).forEach(function (key) { defineProperty$5(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { ownKeys$8(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }
	...
	function _objectSpread$9(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { ownKeys$9(Object(source), true).forEach(function (key) { defineProperty$5(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { ownKeys$9(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }
	...
	function assertType(type) {
	  !isType(type) ? invariant$2(0, "Expected ".concat(inspect(type), " to be a GraphQL type.")) : void 0;
	  return type;
	}
	/**
	...
	function assertNullableType(type) {
	  !isNullableType(type) ? invariant$2(0, "Expected ".concat(inspect(type), " to be a GraphQL nullable type.")) : void 0;
	  return type;
	}
	...
	function () {
	  function GraphQLScalarType(config) {
	    ...
	    !(typeof config.name === 'string') ? invariant$2(0, 'Must provide name.') : void 0;
	    !(typeof config.serialize === 'function') ? invariant$2(0, "".concat(this.name, " must provide \"serialize\" function. If this custom Scalar ") + 'is also used as an input type, ensure "parseValue" and "parseLiteral" ' + 'functions are also provided.') : void 0;

	    if (config.parseValue || config.parseLiteral) {
	      !(typeof config.parseValue === 'function' && typeof config.parseLiteral === 'function') ? invariant$2(0, "".concat(this.name, " must provide both \"parseValue\" and \"parseLiteral\" ") + 'functions.') : void 0;
	    }
	  }
	...
	function () {
	  function GraphQLObjectType(config) {
	    ...
	    !(typeof config.name === 'string') ? invariant$2(0, 'Must provide name.') : void 0;
	    !(config.isTypeOf == null || typeof config.isTypeOf === 'function') ? invariant$2(0, "".concat(this.name, " must provide \"isTypeOf\" as a function, ") + "but got: ".concat(inspect(config.isTypeOf), ".")) : void 0;
	  }
	...
	function defineInterfaces(config) {
	  ...
	  !Array.isArray(interfaces) ? invariant$2(0, "".concat(config.name, " interfaces must be an Array or a function which returns ") + 'an Array.') : void 0;
	  return interfaces;
	}

	function defineFieldMap(config) {
	  var fieldMap = resolveThunk(config.fields) || {};
	  !isPlainObj(fieldMap) ? invariant$2(0, "".concat(config.name, " fields must be an object with field names as keys or a ") + 'function which returns such an object.') : void 0;
	  ...
	  var _loop = function _loop() {
	    ...
	    !isPlainObj(fieldConfig) ? invariant$2(0, "".concat(config.name, ".").concat(fieldName, " field config must be an object")) : void 0;
	    !!fieldConfig.hasOwnProperty('isDeprecated') ? invariant$2(0, "".concat(config.name, ".").concat(fieldName, " should provide \"deprecationReason\" ") + 'instead of "isDeprecated".') : void 0;

	    var field = _objectSpread$a({}, fieldConfig, {
	      isDeprecated: Boolean(fieldConfig.deprecationReason),
	      name: fieldName
	    });

	    !(field.resolve == null || typeof field.resolve === 'function') ? invariant$2(0, "".concat(config.name, ".").concat(fieldName, " field resolver must be a function if ") + "provided, but got: ".concat(inspect(field.resolve), ".")) : void 0;
	    var argsConfig = fieldConfig.args;

	    if (!argsConfig) {
	      field.args = [];
	    } else {
	      !isPlainObj(argsConfig) ? invariant$2(0, "".concat(config.name, ".").concat(fieldName, " args must be an object with argument ") + 'names as keys.') : void 0;
	...
	function () {
	  function GraphQLInterfaceType(config) {
	    ...
	    this._fields = defineFieldMap.bind(undefined, config);
	    !(typeof config.name === 'string') ? invariant$2(0, 'Must provide name.') : void 0;
	    !(config.resolveType == null || typeof config.resolveType === 'function') ? invariant$2(0, "".concat(this.name, " must provide \"resolveType\" as a function, ") + "but got: ".concat(inspect(config.resolveType), ".")) : void 0;
	  }
	...
	function defineTypes(config) {
	  ...
	  !Array.isArray(types) ? invariant$2(0, 'Must provide Array of types or a function which returns ' + "such an array for Union ".concat(config.name, ".")) : void 0;
	  return types;
	}
	...
	/* <T> */
	  ...
	  !isPlainObj(valueMap) ? invariant$2(0, "".concat(type.name, " values must be an object with value names as keys.")) : void 0;
	  return Object.keys(valueMap).map(function (valueName) {
	    var value = valueMap[valueName];
	    !isPlainObj(value) ? invariant$2(0, "".concat(type.name, ".").concat(valueName, " must refer to an object with a \"value\" key ") + "representing an internal value but got: ".concat(inspect(value), ".")) : void 0;
	    !!value.hasOwnProperty('isDeprecated') ? invariant$2(0, "".concat(type.name, ".").concat(valueName, " should provide \"deprecationReason\" instead ") + 'of "isDeprecated".') : void 0;
	    return {
	      name: valueName,
	...
	function defineInputFieldMap(config) {
	  ...
	  for (var _i2 = 0; _i2 < _arr2.length; _i2++) {
	    ...
	    var field = _objectSpread$a({}, fieldMap[fieldName], {
	      name: fieldName
	    });

	    !!field.hasOwnProperty('resolve') ? invariant$2(0, "".concat(config.name, ".").concat(fieldName, " field has a resolve property, but ") + 'Input Types cannot define resolvers.') : void 0;
	    resultFieldMap[fieldName] = field;
	  }
	...
	function () {
	  function GraphQLDirective(config) {
	    ...
	    this.astNode = config.astNode;
	    !config.name ? invariant$2(0, 'Directive must be named.') : void 0;
	    !Array.isArray(config.locations) ? invariant$2(0, 'Must provide locations for directive.') : void 0;
	    var args = config.args;

	    if (!args) {
	      this.args = [];
	    } else {
	      !!Array.isArray(args) ? invariant$2(0, "@".concat(config.name, " args must be an object with argument names as keys.")) : void 0;
	...
	function () {
	  ...
	  function GraphQLSchema(config) {
	    ...
	    if (config && config.assumeValid) {
	      ...
	      !(_typeof$4(config) === 'object') ? invariant$2(0, 'Must provide configuration object.') : void 0;
	      !(!config.types || Array.isArray(config.types)) ? invariant$2(0, "\"types\" must be Array if provided but got: ".concat(inspect(config.types), ".")) : void 0;
	      !(!config.directives || Array.isArray(config.directives)) ? invariant$2(0, '"directives" must be Array if provided but got: ' + "".concat(inspect(config.directives), ".")) : void 0;
	      !(!config.allowedLegacyNames || Array.isArray(config.allowedLegacyNames)) ? invariant$2(0, '"allowedLegacyNames" must be Array if provided but got: ' + "".concat(inspect(config.allowedLegacyNames), ".")) : void 0;
	    }
	...
	function typeMapReducer(map, type) {
	  ...
	  if (map[type.name]) {
	    !(map[type.name] === type) ? invariant$2(0, 'Schema must contain unique named types but contains multiple ' + "types named \"".concat(type.name, "\".")) : void 0;
	    return map;
	  }
	...
	var Source = function Source(body, name, locationOffset) {
	  ...
	  !(this.locationOffset.line > 0) ? invariant$2(0, 'line in locationOffset is 1-indexed and must be positive') : void 0;
	  !(this.locationOffset.column > 0) ? invariant$2(0, 'column in locationOffset is 1-indexed and must be positive') : void 0;
	}; // Conditionally apply `[Symbol.toStringTag]` if `Symbol`s are supported
	...
	var createAbsintheSocketLink = function createAbsintheSocketLink(absintheSocket, onError, onStart) {
	  ...
	  return new ApolloLink(Fun_4(notifierToObservable(absintheSocket, onError, onStart), function (request) {
	    newArrowCheck(this, _this3);
